 ...
 */
LoadingProgressPer = function(panelW,panelH,prgW,prgH,panelBgColor,prgBgColor,prgColor){
    ...
    this._load.on("fileprogress",Global.delegate(this.handleProgress,this));
    this._load.on("complete", Global.delegate(this.handleComplete,this));
    this._load.on("fileload", Global.delegate(this.handleFileLoader,this));

    this.init();
}
LoadingProgressPer.prototype = new createjs.Container();
LoadingProgressPer.prototype.Container_initialize = LoadingProgressPer.prototype.initialize;
LoadingProgressPer.prototype.init = function()
{
...
LoadingProgressPer.prototype.loadFile = function (arrLoad,handleProgress,handleComplete,handleFileLoader) {
    this._index = 0;
...
LoadingProgressPer.prototype.handleProgress = function (event) {
...
LoadingProgressPer.prototype.handleComplete = function(event)
{
...
LoadingProgressPer.prototype.handleFileLoader = function(event)
{
